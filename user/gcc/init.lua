...
function self.build()
    ...
    os.execute(tools.get_flags() ..
        " ../configure --prefix= --disable-multilib --disable-nls --with-system-zlib --with-native-system-header-dir=/usr/include --enable-default-pie --enable-default-ssp --enable-host-pie --enable-languages=c,c++")
