...
local function gen_build(part, projects, runtimes)
    ...
    return function()
        ...
        tools.build_cmake(
            options ..
            (hostfs and ("-DLLVM_ENABLE_LIBEDIT=OFF -DLLVM_ENABLE_LIBPFM=OFF -DCOMPILER_RT_BUILD_SANITIZERS=OFF -DCOMPILER_RT_BUILD_XRAY=OFF -DCOMPILER_RT_BUILD_LIBFUZZER=OFF -DCOMPILER_RT_BUILD_PROFILE=OFF -DCOMPILER_RT_BUILD_MEMPROF=OFF -DCOMPILER_RT_BUILD_CTX_PROFILE=OFF -LLVM_TARGETS_TO_BUILD=" .. arch .. " ") or "") ..
