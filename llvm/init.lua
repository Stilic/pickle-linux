...
local function gen_build(external_llvm, projects, runtimes)
    ...
    return function()
        ...
        tools.build_cmake(external_command ..
            "-DLLVM_PARALLEL_LINK_JOBS=2 -DLLVM_INSTALL_TOOLCHAIN_ONLY=ON -DLLVM_TARGETS_TO_BUILD=" ..
...
variants = {
    libs = {
        build = gen_build(true, "clang-resource-headers", "compiler-rt;libcxx;libcxxabi;libunwind")
    }
}
